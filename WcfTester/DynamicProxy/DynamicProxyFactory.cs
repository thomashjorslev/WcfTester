...
namespace WcfTester.DynamicProxy
{
    public class DynamicProxyFactory
    {
        ...
        public WcfTester.DynamicProxy.DynamicProxy CreateProxy(string contractName)
        {
        ...
        public WcfTester.DynamicProxy.DynamicProxy CreateProxy(ServiceEndpoint endpoint)
        {
            ...
            return new WcfTester.DynamicProxy.DynamicProxy(proxyType, endpoint.Binding,
                    endpoint.Address);
        }
